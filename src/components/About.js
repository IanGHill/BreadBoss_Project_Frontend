...
const About = () => (
  <div className="about-container">
    ...
    <div className="about-right">
      ...
      <p className="aboutFont">Sourdough is bread that is made using naturally occuring wild yeast and lactobacilli (gut-friendly “good” bacteria). These wild yeast and lactobacilli cause the bread to rise without the need to add commercial baker’s yeast and also contribute a characteristic tang to the flavour of the bread. It tends to be more nutritious, flavoursome and easier to digest that bread made using commercial yeast.</p>
